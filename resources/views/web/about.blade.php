                        ...
                        <div class="portfolio-grids gallery-container clearfix">
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="{{ asset('web/assets/images/portfolio/1.jpg') }}" class="fancybox" data-fancybox-group="gall-1">
                            ...
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="{{ asset('web/assets/images/portfolio/2.jpg') }}" class="fancybox" data-fancybox-group="gall-1">
                            ...
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="{{ asset('web/assets/images/portfolio/4.jpg') }}" class="fancybox" data-fancybox-group="gall-1">
                            ...
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="{{ asset('web/assets/images/portfolio/3.jpg') }}" class="fancybox" data-fancybox-group="gall-1">
